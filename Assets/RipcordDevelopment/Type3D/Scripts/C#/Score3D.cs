...
//ABOUT - This script converts an int-based number into a collection of 3D characters representing that number
...
namespace Type3D
{
    public class Score3D : MonoBehaviour
    {
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        // UPDATE Type3D SCORE - Using the given score value, update the Type3D score display
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
